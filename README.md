...
`WGame\ModBackups\BigDickLoganMod-v0.5`
...
- Always uninstall v0.5 before installing another release of this mod.

## Repository layout

- `payload/` contains the verified binary patch and compiled Revision 157 runtime.
- `src/runtime/` contains the runtime source and generated mesh/physics tables used by v0.5.
