...
int main(int argc,char**argv){
 ...
 d->Clear(0,nullptr,D3DCLEAR_TARGET|D3DCLEAR_ZBUFFER|D3DCLEAR_STENCIL,0xff303840,1,0);d->BeginScene();hr=d->DrawIndexedPrimitive(D3DPT_TRIANGLELIST,0,47050,3865,249804,4596);d->EndScene();
