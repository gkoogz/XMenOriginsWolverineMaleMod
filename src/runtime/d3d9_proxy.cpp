...
static void OverlayFrame(IDirect3DDevice9* d){
  ...
  RECT title{(LONG)x+10,(LONG)y,(LONG)(x+w-8),(LONG)y+32};Text(d,captureComplete?"R14 CAPTURE SAVED (F10 AGAIN)":"R14 ORIGINAL | F10 CAPTURE",title,D3DCOLOR_ARGB(255,255,255,255));
  if(menuOpen){
